...
-------
    ...
    >>> omero = Omero('demo.openmicroscopy.org', 4064,
    >>>               'SylvainPrigent', 'password')
    >>> omero.add_observer(ProgressObserver()) # if you need to see progress
...
def _get_data(img, c=0):
    """
    Get 4D numpy array of pixel data, shape = (size_t, size_z, size_y,
    size_x)
