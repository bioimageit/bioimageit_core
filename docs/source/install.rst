...
The easiest method to install BioImageIT is to use installation scripts available in the main website: `here <https://bioimageit.github.io/#/install>`_
Bellow are the instructions to manually install BioImageIT_core.

Install bioimageit_core
-----------------------

BioImageIT core depends on *bioimageit_formats* the library that manage the data formats. 
You first needs to install *bioimageit_formats* and then *bioimageit_core*:
