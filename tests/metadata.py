...
def create_raw_data() -> RawDataContainer:
    ...
    raw_data_container2.uri = os.path.abspath(
...
def create_processed_data() -> ProcessedDataContainer:
    ...
    processed_data_container2.uri = os.path.abspath(
    ...
    processed_data_container2.run_uri = os.path.abspath(
        "tests/test_metadata_local/process1/run.md.json")
    processed_data_container2.add_input('i', os.path.abspath(
...
def create_dataset() -> DataSetContainer:   
    ...
    container.name = 'data'
    container.uris.append(os.path.abspath(
        'tests/test_metadata_local/data/population1_001.md.json'))
    container.uris.append(os.path.abspath(
...
def create_experiment() -> ExperimentContainer:
    ...
    container.rawdataset = os.path.abspath(
        'tests/test_metadata_local/data/rawdataset.md.json')
    container.processeddatasets.append(os.path.abspath(
